...
8. 작업 진행 시 Notion 마로 대시보드(`page_id: 33fdf765-9901-8115-b79e-fd35559298ed`)를 자동으로 업데이트한다.
...
모든 에이전트는 작업 중 개선점을 발견하면 아래 포맷으로 Notion 마로 대시보드(`page_id: 33fdf765-9901-8115-b79e-fd35559298ed`)에 보고한다. Notion 업데이트 실패 시 CHANGELOG.md에 기록.
